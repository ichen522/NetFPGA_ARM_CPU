...
//
//              ARMv4-T Pipelined CPU on NetFPGA
//
///////////////////////////////////////////////////////////////////////////////
...
`define CPU_BLOCK_ADDR_WIDTH            19
`define CPU_REG_ADDR_WIDTH              4
...
`define CPU_BLOCK_ADDR            19'h00008
...
`define CPU_RESET      4'h0
`define CPU_MEM_ADDR   4'h1
`define CPU_MEM_WDATA  4'h2
`define CPU_MEM_CMD    4'h3
`define CPU_MEM_RDATA  4'h4
`define CPU_PC         4'h5
`define CPU_INSTR      4'h6
