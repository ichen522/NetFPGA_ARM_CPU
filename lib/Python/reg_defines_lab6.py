...
#
# Project: Pipeline_CPU (lab6)
# Description: ARMv4-T Pipelined CPU on NetFPGA
#
#############################################################
...
def DEVICE_PROJ_DESC ():
    return "ARMv4-T Pipelined CPU on NetFPGA"
...
# Name: cpu (CPU)
# Description: Pipeline CPU Registers
# File: projects/lab6/include/cpu.xml
def CPU_RESET_REG ():     
    return 0x2000200

def CPU_MEM_ADDR_REG ():  
    return 0x2000204

def CPU_MEM_WDATA_REG (): 
    return 0x2000208

def CPU_MEM_CMD_REG ():   
    return 0x200020c

def CPU_MEM_RDATA_REG (): 
    return 0x2000210
...
__main__.nf_regmap.update({
    ...
    0x2000200 : "CPU_RESET_REG",
    0x2000204 : "CPU_MEM_ADDR_REG",
    0x2000208 : "CPU_MEM_WDATA_REG",
    0x200020c : "CPU_MEM_CMD_REG",
    0x2000210 : "CPU_MEM_RDATA_REG",
    0x2000214 : "CPU_PC_REG",
    0x2000218 : "CPU_INSTR_REG",

    0x2000300 : "IN_ARB_NUM_PKTS_SENT_REG",
    0x2000304 : "IN_ARB_LAST_PKT_WORD_0_HI_REG",
    0x2000308 : "IN_ARB_LAST_PKT_WORD_0_LO_REG",
    0x200030c : "IN_ARB_LAST_PKT_CTRL_0_REG",
    0x2000310 : "IN_ARB_LAST_PKT_WORD_1_HI_REG",
    0x2000314 : "IN_ARB_LAST_PKT_WORD_1_LO_REG",
    0x2000318 : "IN_ARB_LAST_PKT_CTRL_1_REG",
    0x200031c : "IN_ARB_STATE_REG",
