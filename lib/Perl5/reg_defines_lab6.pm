...
sub DEVICE_PROJ_NAME () { "Pipeline_CPU"; }
sub DEVICE_PROJ_DESC () { "ARMv4-T Pipelined CPU on NetFPGA"; }
...
sub CPU_RESET_REG ()       { 0x2000200;}
sub CPU_MEM_ADDR_REG ()    { 0x2000204;}
sub CPU_MEM_WDATA_REG ()   { 0x2000208;}
sub CPU_MEM_CMD_REG ()     { 0x200020c;}
sub CPU_MEM_RDATA_REG ()   { 0x2000210;}
sub CPU_PC_REG ()          { 0x2000214;}
sub CPU_INSTR_REG ()       { 0x2000218;}
